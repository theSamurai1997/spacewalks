...
def plot_cumulative_time_in_space(eva_data, graph_file):
    """
    Process the pandas dataframe and create a plot cumulative time
    spacewalk duration and Save it to graph using matplotlib library

    Args:
        eva_date (pd.DataFrame): The input dataframe
        df (pd.DataFrame): The input dataframe.
        output_file (str): graph using matplotlib library
    ...
    #Plot cumulartive time spent in space over years
